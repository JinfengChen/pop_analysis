...
def runjob(script, lines):
    cmd = 'perl /rhome/cjinfeng/BigData/software/bin/qsub-slurm.pl --queue batch --maxjob 30 --lines %s --interval 120 --task 1 --mem 5G --time 100:00:00 --convert no %s' %(lines, script)
    #print cmd 
    os.system(cmd)
